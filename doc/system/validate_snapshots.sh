...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/SNTSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** SNT" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/SNTSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="SNT"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** SNT" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/SNTSYSTEM.md`' "assembled primary output"
